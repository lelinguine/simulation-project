...
def run_simulation():
    ...
    print(f"  - Coût traitement faible : {config.TREATMENT_COST_WEAK}")
    print(f"  - Coût traitement intense : {config.TREATMENT_COST_INTENSE}")
    print(f"  - Coût mouvement : {config.MOVEMENT_COST}")
    print(f"  - Batterie max : {config.BATTERY_MAX}")
    print(f"  - Recharge/tour : {config.BATTERY_RECHARGE_RATE}")
    ...
    # Section debug supprimée (anomalies restantes)
